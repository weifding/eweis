...
if (!class_exists('CommissionModel')){
    class CommissionModel extends PluginModel{
        public function getSet($weizan_0 = 0){
            ...
            $weizan_1['texts'] = array(
                'agent' => empty($weizan_1['texts']['agent']) ? '分销商' : $weizan_1['texts']['agent'], 
                'shop' => empty($weizan_1['texts']['shop']) ? '小店' : $weizan_1['texts']['shop'], 
                'myshop' => empty($weizan_1['texts']['myshop']) ? '我的小店' : $weizan_1['texts']['myshop'], 
                'center' => empty($weizan_1['texts']['center']) ? '分销中心' : $weizan_1['texts']['center'], 
                'become' => empty($weizan_1['texts']['become']) ? '成为分销商' : $weizan_1['texts']['become'], 
                'withdraw' => empty($weizan_1['texts']['withdraw']) ? '提现' : $weizan_1['texts']['withdraw'], 
                'commission' => empty($weizan_1['texts']['commission']) ? '佣金' : $weizan_1['texts']['commission'], 
                'commission1' => empty($weizan_1['texts']['commission1']) ? '分销佣金' : $weizan_1['texts']['commission1'], 
                'commission_total' => empty($weizan_1['texts']['commission_total']) ? '累计佣金' : $weizan_1['texts']['commission_total'], 
                'commission_ok' => empty($weizan_1['texts']['commission_ok']) ? '可提现佣金' : $weizan_1['texts']['commission_ok'], 
                'commission_apply' => empty($weizan_1['texts']['commission_apply']) ? '已申请佣金' : $weizan_1['texts']['commission_apply'], 
                'commission_check' => empty($weizan_1['texts']['commission_check']) ? '待打款佣金' : $weizan_1['texts']['commission_check'], 
                'commission_lock' => empty($weizan_1['texts']['commission_lock']) ? '未结算佣金' : $weizan_1['texts']['commission_lock'], 
                'commission_detail' => empty($weizan_1['texts']['commission_detail']) ? '佣金明细' : $weizan_1['texts']['commission_detail'], 
                'commission_pay' => empty($weizan_1['texts']['commission_pay']) ? '成功提现佣金' : $weizan_1['texts']['commission_pay'], 
                'order' => empty($weizan_1['texts']['order']) ? '分销订单' : $weizan_1['texts']['order'], 
                'myteam' => empty($weizan_1['texts']['myteam']) ? '我的团队' : $weizan_1['texts']['myteam'], 
                'c1' => empty($weizan_1['texts']['c1']) ? '一级' : $weizan_1['texts']['c1'], 
                'c2' => empty($weizan_1['texts']['c2']) ? '二级' : $weizan_1['texts']['c2'], 
                'c3' => empty($weizan_1['texts']['c3']) ? '三级' : $weizan_1['texts']['c3'], 
                'mycustomer' => empty($weizan_1['texts']['mycustomer']) ? '我的客户' : $weizan_1['texts']['mycustomer'],);
            return $weizan_1;
        }
